...
<config>
  <preferences operation="replace">
    ...
    pro.task(
      [type: Copy, description: 'Puts the plugin-JAR generated by the `jar`-task into `build/.josm/plugins`', dependsOn: [pro.renameDistJar, pro.initJosmPrefs, pro.updatePluginDependencies]],
      'updateCurrentPlugin',
      {t ->
        doFirst {
          pro.logger.lifecycle 'Copy {} to {}…', source.files, destinationDir
